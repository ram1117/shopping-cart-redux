...
**Shopping Cart** is a Single Page Application developed using React and Redux. We use the `create-react-app` toolchain and `redux toolkit` in the application.
...
- **Using Redux for applciation state management**
...
- [Live Demo Link](https://shopping-cart-ram.onrender.com)
...
```sh
  cd <desired-folder>
  git clone https://github.com/ram1117/shopping-cart-redux
...
Feel free to check the [issues page](https://github.com/ram1117/shopping-cart-redux/issues).
...
- **How to report bugs?**
  ...
  - Please raise [github issue](https://github.com/ram1117/shopping-cart-redux/issues) with more details about the bug.
